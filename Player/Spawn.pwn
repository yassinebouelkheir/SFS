...
public OnPlayerSpawn(playerid)
{
    ...
    {
        if(!strcmp(GetName(playerid), "[SAP]Bus[65][0]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[52][0]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[07][0]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[30][0]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[40][0]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[18][0]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[57][0]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[65][1]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[52][1]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[07][1]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[30][1]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[40][1]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[18][1]", true))
        {
        ...
        if(!strcmp(GetName(playerid), "[SAP]Bus[57][1]", true))
        {
